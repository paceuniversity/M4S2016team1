 ...
 * {@link fragment_quiz.OnFragmentInteractionListener} interface
...
public class fragment_quiz extends Fragment {
    ...
    public void faireQuiz(View v) {

        Intent intent = new Intent(this.getActivity(), activity_faire_quiz.class);
